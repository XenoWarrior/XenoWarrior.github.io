var WorkBookL1 = {
    ...
    variablesOutput: function () {
        var someValue = "Level 1 - Basic - Variables";
    ...
    incrementAge: function() {
        var ageBefore = this.personObject.age;
    ...
    createPersonByForm: function() {
        this.personObject.name = $('#l1_f3_e2_name').val();
        this.personObject.age = parseInt($('#l1_f3_e2_age').val());
        this.personObject.job = $('#l1_f3_e2_job').val();
    ...
    heSaidMyName: function() {
        var val = "He said \"My name is Elliott\"";
    ...
    arrayStringsTask: function() { 
        ...
        $('#output').append("<p>Added new item: " + arr + "</p>");
        for(var i = 0; i < arr.length; i++) {
            $('#output').append("<p>--- String Array: " + arr[i] + "</p>");            
        }
        ...
        $('#output').append("<p>Removing last item: " + arr + "</p>");
        for(var i = 0; i < arr.length; i++) {
            $('#output').append("<p>--- String Array: " + arr[i] + "</p>");            
        }
    },
